...
export default function EditProfileScreen() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="relative px-4 pt-4 pb-10 shrink-0 overflow-hidden"
        style={{
          background:
      ...
      >
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-outfit text-[19px] font-bold text-white">
              {t.editProfile.title}
            </h1>
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar px-4 py-5 pb-28 space-y-4">
        ...
        <div>
          ...
          {errors.email && (
            <p className="text-coral text-[11px] mt-1">{errors.email}</p>
          )}
        </div>
