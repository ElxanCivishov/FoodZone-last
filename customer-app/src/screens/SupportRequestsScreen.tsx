...
export default function SupportRequestsScreen() {
  ...
  return (
    ...
    >
      {/* Header */}
      <div
        className="relative px-4 py-6 shrink-0"
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white/70 text-[12px] mt-0.5">
              {requests.length > 0
                ? `${requests.length} ${t.support.request}`
                ...
                return (
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <div
                        className={`w-11 h-11 rounded-xl ${topic.bg} flex items-center justify-center shrink-0`}
                      >
                        <TopicIcon
                          size={20}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between gap-2">
                          <p className="text-[14px] font-semibold text-text-primary">
                            {t.support.topics[req.topic]}
                          </p>
                          <div
                            className={`flex items-center gap-1 px-2 py-0.5 rounded-full shrink-0 ${status.bg}`}
                          >
